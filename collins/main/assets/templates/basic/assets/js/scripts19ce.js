  ...
  NioApp.CurrentLink = function () {
    ...
    $(_link).each(function () {
      ...
      if (fileName.match(_self_link)) {
        self.closest("li").addClass('active ').parents().closest("li").addClass("active ");
      } else {
        self.closest("li").removeClass('active ').parents().closest("li:not(.current-page)").removeClass("active");
      }
    });
  }; // PasswordSwitch @v1.0
